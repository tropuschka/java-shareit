...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getUserBooking(long userId, String state) {
    ...
    public ResponseEntity<Object> ownerApprove(long userId, Long bookingId, Boolean approved) {
        Map<String, Object> parameters = Map.of(
                "approved", approved
        );
